...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(133, 81);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(133, 55);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(133, 29);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (!textBox1->Text->Equals("")
			...
			MessageBox::Show("Please input two numbers");
		}
